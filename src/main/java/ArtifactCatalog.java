...
public final class ArtifactCatalog {
    ...
    private static Map<String, ImageInfo> createInfoMap() {
        ...
        return Collections.unmodifiableMap(map); // prevents accidental edits
    }

    /** Collections */
    public static final String CYPRUS = "/Ancient Cyprus";
    public static final String GREECE = "/Ancient Greece";
    public static final String ROME   = "/Rome";
    public static final String NEAR_EAST = "/Ancient Near East";
    public static final String EGYPT = "/Ancient Egypt";

    private static final Map<String, List<String>> COLLECTIONS = createCollections();
    private static Map<String, List<String>> createCollections() {
